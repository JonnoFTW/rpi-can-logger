...
_pids = [
    ...
    PID(0x0113, 'PID_OXYGEN_SENSOR_2', Unit.OxygenVoltageTrim, 'field'),
    PID(0x0114, 'PID_OXYGEN_SENSOR_3', Unit.OxygenVoltageTrim, 'field'),
    PID(0x0115, 'PID_OXYGEN_SENSOR_4', Unit.OxygenVoltageTrim, 'field'),
    PID(0x0116, 'PID_OXYGEN_SENSOR_5', Unit.OxygenVoltageTrim, 'field'),
    PID(0x0116, 'PID_OXYGEN_SENSOR_6', Unit.OxygenVoltageTrim, 'field'),
    PID(0x0116, 'PID_OXYGEN_SENSOR_7', Unit.OxygenVoltageTrim, 'field'),
    PID(0x0116, 'PID_OXYGEN_SENSOR_8', Unit.OxygenVoltageTrim, 'field'),
    ...
    PID(0x0135, 'PID_OXYGEN_SENSOR_2_FUEL', Unit.OxygenRatioCurrent, 'field'),
    PID(0x0136, 'PID_OXYGEN_SENSOR_3_FUEL', Unit.OxygenRatioCurrent, 'field'),
    PID(0x0137, 'PID_OXYGEN_SENSOR_4_FUEL', Unit.OxygenRatioCurrent, 'field'),
    PID(0x0138, 'PID_OXYGEN_SENSOR_5_FUEL', Unit.OxygenRatioCurrent, 'field'),
    PID(0x0139, 'PID_OXYGEN_SENSOR_6_FUEL', Unit.OxygenRatioCurrent, 'field'),
    PID(0x013A, 'PID_OXYGEN_SENSOR_7_FUEL', Unit.OxygenRatioCurrent, 'field'),
    PID(0x013B, 'PID_OXYGEN_SENSOR_8_FUEL', Unit.OxygenRatioCurrent, 'field'),
